...
namespace WinFormsApp1
{
    public partial class Form3 : Form
    {
        public Form3()
        {
            ...
            textBox1.Text = "Введите старый код-доступа";
        ...
        {
            if ((textBox1.Text == "Введите старый код-доступа") || (textBox1.Text == "Введите новый код-доступа"))
            {
                textBox1.Clear();
        ...
        private void n_2_Click_1(object sender, EventArgs e)
        {
            if ((textBox1.Text == "Введите старый код-доступа") || (textBox1.Text == "Введите новый код-доступа"))
            {
                textBox1.Clear();
        ...
        private void bEnter_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand command = new MySqlCommand("SELECT cod FROM `codes` WHERE cod = @cd;", dB.getConnection());
            ...
            if (table.Rows.Count > 0)
            {
                ...
                // Устанавливаем подсказку для TextBox
                textBox1.Text = "Введите новый код-доступа";
                textBox1.ForeColor = SystemColors.GrayText;
                // Отображение кнопки
                codDostup.Visible = true;
            }
            else
            {
        ...
        private void codDostup_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand command = new MySqlCommand("UPDATE codes SET cod = @cd WHERE id = 1;", dB.getConnection());
